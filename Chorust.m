classdef Chorust< audioPlugin
    properties
        delayLength = 0.013; % Delay length in seconds
    ...
    properties (Constant)
        PluginInterface = audioPluginInterface(...
            audioPluginParameter('delayLength', 'Label', 's', 'Mapping',{'lin',0.01, 0.05}, 'Style', 'rotaryknob', 'Layout', [3,1], 'DisplayName', 'Delay Time', 'DisplayNameLocation', 'Above'),...
    ...
    methods
        function reset(obj)
            ...
            obj.delayLengthSamples = round(obj.delayLength * sampleRate);
        ...
        function output = process(obj, input)
            ...
            for i = 1:length(input)
                ...
                output(i, :) = [newSampleLeft; newSampleRight];
            end
